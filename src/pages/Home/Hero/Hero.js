...
const Hero = () => {
    return (
        <div className="bg-center bg-cover flex items-center h-[400px] md:h-[700px] w-full" style={{backgroundImage : `url(https://i.ibb.co/YWB0sdD/3ecde-01.jpg)`}} bg-cover='true' bg-center='true'>
